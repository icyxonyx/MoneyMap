...
class FilterViewPage extends Component {
    ...
    if (urlParams) {
      if (urlParams.from[0] === "monthpage") {
        ...
        const endDate = moment(
          `${selectedMonth}/${noOfDaysInMonth}/${selectedYear}`
        );
  ...
  componentDidMount() {
    ...
    if (this.props.settings && this.props.settings.travelMode === "on") {
      ...
      fetch(
        `https://api.freecurrencyapi.com/v1/latest?apikey=fca_live_4Q9Ke8YvqMqCHR5h247tWFQZsHPvEGnJsq9lRxv5`
      )
