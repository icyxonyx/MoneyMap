    ...
    this.state = {
      ...
      editedCategories: this.props.settings
        ? this.props.settings.editedCategories
          ? {
              Food: this.props.settings.editedCategories["Food"]
                ? this.props.settings.editedCategories["Food"]
                : "",
              Automobile: this.props.settings.editedCategories["Automobile"]
                ? this.props.settings.editedCategories["Automobile"]
                : "",
              Entertainment: this.props.settings.editedCategories[
                "Entertainment"
              ]
                ? this.props.settings.editedCategories["Entertainment"]
                : "",
              Clothing: this.props.settings.editedCategories["Clothing"]
                ? this.props.settings.editedCategories["Clothing"]
                : "",
              Healthcare: this.props.settings.editedCategories["Healthcare"]
                ? this.props.settings.editedCategories["Healthcare"]
                : "",
              Travel: this.props.settings.editedCategories["Travel"]
                ? this.props.settings.editedCategories["Travel"]
                : "",
              Shopping: this.props.settings.editedCategories["Shopping"]
                ? this.props.settings.editedCategories["Shopping"]
                : "",
              "Personal Care": this.props.settings.editedCategories[
                "Personal Care"
              ]
                ? this.props.settings.editedCategories["Personal Care"]
                : "",
              Investment: this.props.settings.editedCategories["Investment"]
                ? this.props.settings.editedCategories["Investment"]
                : "",
              "Gifts & Donations": this.props.settings.editedCategories[
                "Gifts & Donations"
              ]
                ? this.props.settings.editedCategories["Gifts & Donations"]
                : "",
              "Bills & Utilities": this.props.settings.editedCategories[
                "Bills & Utilities"
              ]
                ? this.props.settings.editedCategories["Bills & Utilities"]
                : "",
              Others: this.props.settings.editedCategories["Others"]
  ...
  render() {
    ...
    if (this.props.settings && this.props.user && this.props.cards) {
      const styleFromSettings = {
        fontFamily: this.props.settings
      ...
      const settingsHeader = {
        background:
          this.props.settings.mode === "night" ? "rgb(44, 43, 43)" : "#2b2b2",
        color:
          this.props.settings.mode === "night"
            ? "rgb(169, 160, 160)"
            : "#2b2b2",
        ...
        <div className="container-fluid" style={styleFromSettings}>
          <div className="row">
            <div className="col-sm-6" style={centerHeight}>
              <img
                src={this.props.user.photoURL || url}
                style={userImage}
                  ...
                  <div className="card card3" style={this.props.cards.card3}>
                    <div className="card-body">
                      ...
                      <p className="card-title">
                        Registered email : {this.props.user.email}
                      </p>
                      <hr />
                      <p className="card-title">
